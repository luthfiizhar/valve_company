  ...
  return (
    <section style={{
      ...
      <div className="container w-full max-auto h-auto mb-6">
        <div className=" flex flex-col lg:flex-row  gap-[20px] lg:gap-[32px] p-8 lg:p-16 mt-8 lg:items-start">
          <div className="order-2 lg:order-1 w-full flex flex-col items-center lg:items-start gap-[24px]">
            <div className="flex flex-col text-accent text-[16px] lg:text-[20px]">
